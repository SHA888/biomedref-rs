# Contributing to biomedref-rs

Thank you for your interest in contributing to biomedref-rs! This document provides guidelines for contributors.
...
We follow the same conventions as multiomics-rs:
...
Example: `feat(foodb-rs): add CSV reader for food.csv`
...
1. Create a tag following the pattern `<crate>-v<version>` (e.g., `foodb-rs-v0.1.0`)
...
- Refer to the multiomics-rs repository for additional patterns and conventions
