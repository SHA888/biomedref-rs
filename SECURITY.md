...
For biomedref-rs, data correctness bugs are treated with security severity because:
...
- Incorrect parsing of biomedical reference identifiers
- Wrong data type conversions (e.g., treating missing values as zeros)
- Mishandling of gene/protein/food identifiers
- Errors in data aggregation or filtering
- Incorrect confidence score parsing or propagation
...
When working with biomedical reference data:
